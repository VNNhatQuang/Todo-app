...
$(document).ready(function () {
  ...
  var rowHeaderMain = $('.row');
  var user = $('#user');
  var userNav = $('#user-nav');
  user.click(function () {
    userNav.toggle();
  });
  rowHeaderMain.click(function () {
  ...
  if (checkComplete.length === notes.length) {
    for (var index = 0; index < checkComplete.length; index++) {
      var check = checkComplete[index];
      var _form = notes[index];
      checkCompleteNoteArray.push({
        check: check,
        form: _form
      });
    }
  }
  checkCompleteNoteArray.forEach(function (element) {
    element.check.addEventListener('click', function () {
      element.form.submit();
    });
  });
  ...
  deleteNote.click(function (e) {
    var response = confirm('Xác nhận xóa?');
  ...
  if (editNoteButton.length === editNoteForm.length) {
    for (var _index = 0; _index < editNoteButton.length; _index++) {
      var editButton = editNoteButton[_index];
      var editForm = editNoteForm[_index];
      var note = notes[_index];
      editNoteArray.push({
  ...
  editNoteArray.forEach(function (element) {
...
/******/ 	__webpack_require__.O(undefined, ["css/responsive","css/app","css/login"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/responsive","css/app","css/login"], () => (__webpack_require__("./resources/css/login.css")))
/******/ 	__webpack_require__.O(undefined, ["css/responsive","css/app","css/login"], () => (__webpack_require__("./resources/css/app.css")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/responsive","css/app","css/login"], () => (__webpack_require__("./resources/css/responsive.css")))
